      ...
      {isLoginOpen && (
        ...
        >
          <div className="py-1 font-bold " role="none">
            <Link to="/admin-login" className="text-gray-700 block px-4 py-2 text-sm hover:bg-primary hover:text-white" role="menuitem">
              Admin Login
            </Link>
            <Link to="/student-login" className="text-gray-700 block px-4 py-2 text-sm hover:bg-primary hover:text-white" role="menuitem">
              Student Login
            </Link>
          </div>
        </div>
