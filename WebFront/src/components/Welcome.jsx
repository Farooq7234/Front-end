    ...
    <>
        <div>
            <div className="bgWelcomebg text-white text-center h-auto w-full md:w-1/2  flex flex-col border-none rounded-3xl ml-auto mr-auto sm:left-0 justify-center items-center">
              <h1 className="font-semibold lg:text-3xl text-xm p-6 md:p-6 mt-6 sm:mt-8 border-b">HOSTEL MESS BILL MANAGEMENT SYSTEM</h1>
              <hr className="my-2"/>
              <p className="m-4 md:m-8 text-sm ml-8 mr-8 lg:text-xl lg:mb-28 mb-10 tracking-wider"> "HOME AWAY FROM HOME". The aim of running hostel to provide a homely environment for the student. They have been designed to provide a Comfortable, Safe and Scure living. The hostel is managed by the hostel Residents, Chief warden, Warden, Manager, Deputy Warden and Student Representatives. </p>
            </div>
        </div>
